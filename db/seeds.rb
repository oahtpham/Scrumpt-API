...
#SPRINT SEEDS
sprint1 = Sprint.create(sprint_name: "hijack spotify api", deadline: "2019-02-15", color: "blue")
sprint2 = Sprint.create(sprint_name: "get rid of Thao", deadline: "2019-02-15", color: "red")
sprint3 = Sprint.create(sprint_name: "face recognition", deadline: "2019-02-15", color: "yellow")
#STAGE SEEDS
